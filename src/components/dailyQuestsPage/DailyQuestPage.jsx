...
//             {/* Daily Quests on the Left */}
//             <div className="flex-1 max-w-md mx-2 z-0">
//               <DailyQuests />
//             </div>

//             {/* Right Section containing Your Progress and Vision Board */}
//             <div className="flex-1 flex flex-col mx-2 z-0">
//               <h3 className="text-2xl font-bold text-gray-800 mb-4">
//                 Your Progress
//               </h3>
//               <div className="flex flex-row gap-4 z-0">
...
//               {/* Vision Board aligned below Your Progress */}
